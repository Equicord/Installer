...
const ReleaseUrl = "https://api.github.com/repos/Stormcord/Stormcord/releases/latest"
const InstallerReleaseUrl = "https://api.github.com/repos/Stormcord/Installer/releases/latest"

var UserAgent = "StormcordInstaller/" + InstallerGitHash + " (https://github.com/Stormcord/Installer)"
